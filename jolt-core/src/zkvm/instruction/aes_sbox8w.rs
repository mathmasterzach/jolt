...
use tracer::instruction::{aes_sbox8w::AESSBOX8W, RISCVCycle};

use crate::zkvm::lookup_table::{aes_sbox8w::AesSbox8WTable, LookupTables};

use super::{CircuitFlags, Flags, InstructionLookup, LookupQuery, NUM_CIRCUIT_FLAGS};

impl<const XLEN: usize> InstructionLookup<XLEN> for AESSBOX8W {
    fn lookup_table(&self) -> Option<LookupTables<XLEN>> {
        Some(AesSbox8WTable.into())
    }
}

impl Flags for AESSBOX8W {
...
impl<const XLEN: usize> LookupQuery<XLEN> for RISCVCycle<AESSBOX8W> {
...
mod test {
    ...
    fn materialize_entry() {
        materialize_entry_test::<Fr, AESSBOX8W>();
    }

    #[test]
    fn lookup_output_matches_trace() {
        lookup_output_matches_trace_test::<AESSBOX8W>();
    }
}
